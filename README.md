...
·    Start the development server: npm run dev         ·    Open http://localhost:5173 in a browser.
	·	To create a production build: npm run build
Pre-seeded admin account:  admin@grandazure.com  /  admin1232	Folder Structure
hotel-booking-app/
hotel-booking-app/
├── public/
│   ├── data/
